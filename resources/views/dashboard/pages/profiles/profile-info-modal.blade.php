<div x-show="isProfileInfoModal" class="fixed inset-0 flex items-start justify-center p-5 overflow-y-auto z-99999">
    ...
    <div @click.outside="isProfileInfoModal = false" class="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
        ...
        <form id="modal-form-input" action="{{ route('profiles.update', auth()->user()->uuid) }}" enctype="multipart/form-data" class="flex flex-col">
            @csrf
            @method('PUT')
                ...
                <div class="mt-7">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                        <div class="col-span-2 lg:col-span-1">
                            <label for="avatar_url" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                Avatar
                            </label>
                        ...
                        <div class="col-span-2 lg:col-span-1">
                            ...
                            <div class="text-red-400 text-sm message" id="error-email"></div>
                        </div>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            $('#modal-form-input').on('submit', function(e) {
                e.preventDefault();
